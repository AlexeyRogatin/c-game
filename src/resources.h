...
void load_bitmaps(Game_memory *memory, READ_BMP(win32_read_bmp))
{
    ...
    memory->bitmaps[2] = win32_read_bmp("./bitmaps/lexaIdle.bmp");
    ...
    memory->bitmaps[11] = win32_read_bmp("./bitmaps/lexaStep3.bmp");
    memory->bitmaps[12] = win32_read_bmp("./bitmaps/lexaStep4.bmp");
    memory->bitmaps[13] = win32_read_bmp("./bitmaps/lexaStep5.bmp");
    memory->bitmaps[14] = win32_read_bmp("./bitmaps/lexaStep6.bmp");
    memory->bitmaps[15] = win32_read_bmp("./bitmaps/lexaCrouchIdle1.bmp");
    memory->bitmaps[16] = win32_read_bmp("./bitmaps/lexaCrouchIdle2.bmp");
    memory->bitmaps[17] = win32_read_bmp("./bitmaps/lexaCrouchIdle3.bmp");
    memory->bitmaps[18] = win32_read_bmp("./bitmaps/lexaCrouchIdle4.bmp");
    memory->bitmaps[19] = win32_read_bmp("./bitmaps/lexaCrouchStep1.bmp");
    memory->bitmaps[20] = win32_read_bmp("./bitmaps/lexaCrouchStep2.bmp");
    memory->bitmaps[21] = win32_read_bmp("./bitmaps/lexaCrouchStep3.bmp");
    memory->bitmaps[22] = win32_read_bmp("./bitmaps/lexaCrouchStep4.bmp");
    memory->bitmaps[23] = win32_read_bmp("./bitmaps/lexaCrouchStep5.bmp");
    memory->bitmaps[24] = win32_read_bmp("./bitmaps/lexaCrouchStep6.bmp");
