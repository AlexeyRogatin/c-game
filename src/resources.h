...
void load_bitmaps(Game_memory *memory, READ_BMP(win32_read_bmp))
{
    ...
    memory->bitmaps[2] = win32_read_bmp("./bitmaps/jenjaIdle.bmp");
    memory->bitmaps[3] = win32_read_bmp("./bitmaps/jenjaJump.bmp");
    memory->bitmaps[4] = win32_read_bmp("./bitmaps/jenjaCrouchIdle.bmp");
    memory->bitmaps[5] = win32_read_bmp("./bitmaps/jenjaWall.bmp");
    memory->bitmaps[6] = win32_read_bmp("./bitmaps/jenjaWallUp.bmp");
    memory->bitmaps[7] = win32_read_bmp("./bitmaps/jenjaWallDown.bmp");
    memory->bitmaps[8] = win32_read_bmp("./bitmaps/jenjaLookingUp.bmp");
    memory->bitmaps[9] = win32_read_bmp("./bitmaps/jenjaStep1.bmp");
    memory->bitmaps[10] = win32_read_bmp("./bitmaps/jenjaStep2.bmp");
    memory->bitmaps[11] = win32_read_bmp("./bitmaps/jenjaStep3.bmp");
    memory->bitmaps[12] = win32_read_bmp("./bitmaps/jenjaStep4.bmp");
    memory->bitmaps[13] = win32_read_bmp("./bitmaps/jenjaStep5.bmp");
    memory->bitmaps[14] = win32_read_bmp("./bitmaps/jenjaStep6.bmp");
    memory->bitmaps[15] = win32_read_bmp("./bitmaps/jenjaCrouchIdle1.bmp");
    memory->bitmaps[16] = win32_read_bmp("./bitmaps/jenjaCrouchIdle2.bmp");
    memory->bitmaps[17] = win32_read_bmp("./bitmaps/jenjaCrouchIdle3.bmp");
    memory->bitmaps[18] = win32_read_bmp("./bitmaps/jenjaCrouchIdle4.bmp");
    memory->bitmaps[19] = win32_read_bmp("./bitmaps/jenjaCrouchStep1.bmp");
    memory->bitmaps[20] = win32_read_bmp("./bitmaps/jenjaCrouchStep2.bmp");
    memory->bitmaps[21] = win32_read_bmp("./bitmaps/jenjaCrouchStep3.bmp");
    memory->bitmaps[22] = win32_read_bmp("./bitmaps/jenjaCrouchStep4.bmp");
    memory->bitmaps[23] = win32_read_bmp("./bitmaps/jenjaCrouchStep5.bmp");
    memory->bitmaps[24] = win32_read_bmp("./bitmaps/jenjaCrouchStep6.bmp");
